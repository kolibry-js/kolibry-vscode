...
<body>
  <div style="text-align: center"><p>Kolibry server is not found on <code>${serverAddr}</code></p><p>please run <code style="color: #679bbb">$ kolibry</code> first</p><br><button onclick="configPort()">Config Server Port</button></div>
</body>
`
